...
**Current version:** [v4.4.2](VERSION)
...
| [`docs/pr-ci-cd-workflow.md`](docs/pr-ci-cd-workflow.md) | **PR + CI/CD runbook** — local review gates, preview deploys, production promotion rules |
